...
void SidePanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->tasksClicked(); break;
        case 1: _t->settingsClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SidePanel::*)()>(_a, &SidePanel::tasksClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SidePanel::*)()>(_a, &SidePanel::settingsClicked, 1))
            return;
    }
}
