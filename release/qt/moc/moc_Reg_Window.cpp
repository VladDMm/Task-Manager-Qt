...
#include "../../../src/headers/Reg_Window.h"
...
template <> constexpr inline auto Reg_Window::qt_create_metaobjectdata<qt_meta_tag_ZN10Reg_WindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Reg_Window",
        "register_button_reg_win_clicked",
        "",
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'register_button_reg_win_clicked'
...
void Reg_Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->register_button_reg_win_clicked(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Reg_Window::*)()>(_a, &Reg_Window::register_button_reg_win_clicked, 0))
            return;
    }
}
...
// SIGNAL 0
void Reg_Window::register_button_reg_win_clicked()
{
